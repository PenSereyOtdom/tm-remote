...
class CreateZoomTask extends Task
{
    ...
    public function run(array $data)
    {
        try {
            ...
            $note = $data['note'];
            $type = 2;
            $dataToSaveDB = array("topic"=>$zoom_res->topic,"start_time"=>$zoom_res->start_time,"password"=>$zoom_res->password,'join_url'=>$zoom_res->join_url,"note"=>$note,"user_id"=>$user_id);
